...
//    private val mockAwaitingStateFactory = mock(AwaitingStateFactory::class.java)
//    private val mockDeliveryStateFactory = mock(DeliveryStateFactory::class.java)
//    private val mockPickupStateFactory = mock(PickupStateFactory::class.java)
//
//
//
//
...
//        mockAwaitingStateFactory,
//        mockDeliveryStateFactory,
//        mockPickupStateFactory,
//        )
//
//    // --- FIX END ---
//
...
//        val transition: Transition? = when (val state = currentState) {
//
...
//                    postDeliveryReducer.reduce(state, screenInput, isRecovery = false)
